...
static SAMPLE VERMOUTHCL resample_vibrate(VOICE v, SAMPLE dst, SAMPLE dstterm) {
...
static SAMPLE VERMOUTHCL resample_vibloop(VOICE v, SAMPLE dst, SAMPLE dstterm) {
...
static const MIXPROC mixproc[] = {mixnor_normal, mixnor_left,   mixnor_right,
                                  mixnor_centre, mixenv_normal, mixenv_left,
                                  mixenv_right,  mixenv_centre, mixrel_normal,
                                  mixrel_left,   mixrel_right,  mixrel_centre};
