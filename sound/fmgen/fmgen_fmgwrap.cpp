...
bool OPN_Init(void *OPN, uint c, uint r, bool ip, const char *str) {
  return ((FM::OPN *)OPN)->Init(c, r, ip);
}
bool OPN_SetRate(void *OPN, uint c, uint r, bool b) {
  return ((FM::OPN *)OPN)->SetRate(c, r);
}
...
void SOUNDCALL OPN_Mix(void *OPN, int32 *buffer, int nsamples) {
  ((FM::OPN *)OPN)->Mix(buffer, nsamples);
}
void OPN_SetReg(void *OPN, uint addr, uint data) {
  ((FM::OPN *)OPN)->SetReg(addr, data);
}
...
bool OPM_Init(void *OPM, uint c, uint r, bool ip) {
  return ((FM::OPM *)OPM)->Init(c, r, ip);
}
bool OPM_SetRate(void *OPM, uint c, uint r, bool b) {
  return ((FM::OPM *)OPM)->SetRate(c, r, b);
}
