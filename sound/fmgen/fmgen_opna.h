...
public:
  ...
  bool Init(uint c, uint r, bool = false, const char *rhythmpath = nullptr);
...
public:
  ...
  bool Init(uint c, uint r, bool = false, uint8 *_adpcma = nullptr,
            int _adpcma_size = 0, uint8 *_adpcmb = nullptr,
            int _adpcmb_size = 0);
...
inline void FM::OPNBase::SetVolumePSG(int db) { psg.SetVolume(db); }
