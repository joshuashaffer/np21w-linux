...
#define MEMP_READ8(addr) memp_read8((addr))
#define MEMP_READ16(addr) memp_read16((addr))
#define MEMP_READ32(addr) memp_read32((addr))
#define MEMP_WRITE8(addr, dat) memp_write8((addr), (dat))
#define MEMP_WRITE16(addr, dat) memp_write16((addr), (dat))
#define MEMP_WRITE32(addr, dat) memp_write32((addr), (dat))
#define MEMP_READS(addr, dat, leng) memp_reads((addr), (dat), (leng))
#define MEMP_WRITES(addr, dat, leng) memp_writes((addr), (dat), (leng))

// ---- Logical Space (BIOS)

#define MEML_READ8(addr) meml_read8((addr))
#define MEML_READ16(addr) meml_read16((addr))
#define MEML_READ32(addr) meml_read32((addr))
#define MEML_WRITE8(addr, dat) meml_write8((addr), (dat))
#define MEML_WRITE16(addr, dat) meml_write16((addr), (dat))
#define MEML_WRITE32(addr, dat) meml_write32((addr), (dat))
#define MEML_READS(addr, dat, leng) meml_reads((addr), (dat), (leng))
#define MEML_WRITES(addr, dat, leng) meml_writes((addr), (dat), (leng))

#define MEMR_READ8(seg, off) memr_read8((seg), (off))
#define MEMR_READ16(seg, off) memr_read16((seg), (off))
#define MEMR_WRITE8(seg, off, dat) memr_write8((seg), (off), (dat))
#define MEMR_WRITE16(seg, off, dat) memr_write16((seg), (off), (dat))
#define MEMR_READS(seg, off, dat, leng) memr_reads((seg), (off), (dat), (leng))
