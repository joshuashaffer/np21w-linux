...
float float32_to_c_float(float32 a) { return *((float *)(&a)); }
double float64_to_c_double(float64 a) { return *((double *)(&a)); }
float32 c_float_to_float32(float a) { return *((float32 *)(&a)); }
float64 c_double_to_float64(double a) { return *((float64 *)(&a)); }
