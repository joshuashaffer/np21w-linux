 ...
 * @return インスタンス
 */
inline Np2Arg *Np2Arg::GetInstance() { return &sm_instance; }
 ...
 * @return ディスク パス
 */
inline LPCTSTR Np2Arg::disk(int nDrive) const { return m_lpDisk[nDrive]; }

/**
 * INI パスを得る
 * @return INI パス
 */
inline LPCTSTR Np2Arg::iniFilename() const { return m_lpIniFile; }
 ...
 */
inline bool Np2Arg::fullscreen() const { return m_fFullscreen; }
