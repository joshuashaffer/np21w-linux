 ...
 * コンストラクタ
 */
CWABPage::CWABPage() : CPropPageProc(IDD_WAB) {}
/**
 * デストラクタ
 */
CWABPage::~CWABPage() {}
...
void CWABPage::OnOK() {
  ...
  if (np2cfg.wabasw != m_awitch || np2wabcfg.multiwindow != m_multiwindow ||
 ...
 * コンストラクタ
 */
CGD5430Page::CGD5430Page() : CPropPageProc(IDD_GD5430) {}
/**
 * デストラクタ
 */
...
void CGD5430Page::OnOK() {
  ...
  if (np2cfg.usegd5430 != m_enabled || np2cfg.gd5430type != m_type ||
