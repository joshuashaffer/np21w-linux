 ...
 * コンストラクタ
 */
SndOptMixerPage::SndOptMixerPage() : CPropPageProc(IDD_SNDMIX) {}
 ...
 * コンストラクタ
 */
SndOpt14Page::SndOpt14Page() : CPropPageProc(IDD_SND14) {}
...
BOOL SndOpt14Page::OnInitDialog() {
  static const Item s_snd14item[6] = {
      {IDC_VOL14L, IDC_VOL14LSTR}, {IDC_VOL14R, IDC_VOL14RSTR},
      {IDC_VOLF2, IDC_VOLF2STR},   {IDC_VOLF4, IDC_VOLF4STR},
      {IDC_VOLF8, IDC_VOLF8STR},   {IDC_VOLF16, IDC_VOLF16STR},
  };
...
static const CComboData::Entry s_rom26[] = {
    {MAKEINTRESOURCE(IDS_C8000), 0x00},      {MAKEINTRESOURCE(IDS_CC000), 0x01},
    {MAKEINTRESOURCE(IDS_D0000), 0x02},      {MAKEINTRESOURCE(IDS_D4000), 0x03},
 ...
 * コンストラクタ
 */
SndOpt26Page::SndOpt26Page() : CPropPageProc(IDD_SND26), m_snd26(0) {}
...
static const CComboData::Entry s_id86[] = {
    {MAKEINTRESOURCE(IDS_0X), 0xe0}, {MAKEINTRESOURCE(IDS_1X), 0xc0},
    {MAKEINTRESOURCE(IDS_2X), 0xa0}, {MAKEINTRESOURCE(IDS_3X), 0x80},
    {MAKEINTRESOURCE(IDS_4X), 0x60}, {MAKEINTRESOURCE(IDS_5X), 0x40},
    {MAKEINTRESOURCE(IDS_6X), 0x20}, {MAKEINTRESOURCE(IDS_7X), 0x00},
};

/**
 * コンストラクタ
 */
SndOpt86Page::SndOpt86Page() : CPropPageProc(IDD_SND86), m_snd86(0) {}
...
BOOL SndOpt86Page::OnCommand(WPARAM wParam, LPARAM lParam) {
  ...
  case IDC_SND86INT:
    SetJumper((IsDlgButtonChecked(IDC_SND86INT) != BST_UNCHECKED) ? 0x10 : 0x00,
              0x10);
    break;
  ...
  case IDC_SND86ROM:
    SetJumper((IsDlgButtonChecked(IDC_SND86ROM) != BST_UNCHECKED) ? 0x02 : 0x00,
              0x02);
    break;
...
static const CComboData::Entry s_id118[] = {
    {MAKEINTRESOURCE(IDS_0X), 0x00}, {MAKEINTRESOURCE(IDS_1X), 0x10},
    {MAKEINTRESOURCE(IDS_2X), 0x20}, {MAKEINTRESOURCE(IDS_3X), 0x30},
    {MAKEINTRESOURCE(IDS_4X), 0x40}, {MAKEINTRESOURCE(IDS_5X), 0x50},
    {MAKEINTRESOURCE(IDS_6X), 0x60}, {MAKEINTRESOURCE(IDS_7X), 0x70},
...
SndOpt118Page::SndOpt118Page()
    : CPropPageProc(IDD_SND118), m_snd118io(0), m_snd118id(0), m_snd118dma(0),
      m_snd118irqf(0), m_snd118irqp(0), m_snd118irqm(0), m_snd118rom(0) {}
...
LRESULT SndOpt118Page::WindowProc(UINT nMsg, WPARAM wParam, LPARAM lParam) {
  ...
  case WM_DRAWITEM:
    if (LOWORD(wParam) == IDC_SND118JMP) {
      UINT8 *pBitmap =
          dipswbmp_getsnd118(m_snd118io, m_snd118dma, m_snd118irqf,
                             m_snd118irqp, m_snd118irqm, m_snd118rom);
...
SndOptWSSPage::SndOptWSSPage()
    : CPropPageProc(IDD_SNDWSS), m_snd118id(0), m_snd118dma(0),
      m_snd118irqp(0) {}
...
static const CComboData::Entry s_iosb16[] = {
    {MAKEINTRESOURCE(IDS_20D2), 0xD2}, {MAKEINTRESOURCE(IDS_20D4), 0xD4},
    {MAKEINTRESOURCE(IDS_20D6), 0xD6}, {MAKEINTRESOURCE(IDS_20D8), 0xD8},
    {MAKEINTRESOURCE(IDS_20DA), 0xDA}, {MAKEINTRESOURCE(IDS_20DC), 0xDC},
...
SndOptSB16Page::SndOptSB16Page()
    : CPropPageProc(IDD_SNDSB16), m_snd118io(0), m_snd118dma(0),
      m_snd118irqf(0) {}
 ...
 * コンストラクタ
 */
SndOptSpbPage::SndOptSpbPage() : CPropPageProc(IDD_SNDSPB), m_spb(0), m_vr(0) {}
...
void SndOptSpbPage::OnOK() {
  ...
  const UINT8 cRev =
      (IsDlgButtonChecked(IDC_SPBREVERSE) != BST_UNCHECKED) ? 1 : 0;
 ...
 * コンストラクタ
 */
SndOptPadPage::SndOptPadPage() : CPropPageProc(IDD_SNDPAD1) {}
...
BOOL SndOptPadPage::OnInitDialog() {
  CheckDlgButton(IDC_JOYPAD1,
                 (np2oscfg.JOYPAD1 & 1) ? BST_CHECKED : BST_UNCHECKED);

  for (UINT i = 0; i < _countof(s_pad); i++) {
    for (UINT j = 0; j < 3; j++) {
      CheckDlgButton(s_pad[i][j], (np2oscfg.JOY1BTN[i] & (1 << j))
                                      ? BST_CHECKED
                                      : BST_UNCHECKED);
    }
  }
...
void SndOptPadPage::OnOK() {
  ...
  const UINT8 cJoyPad =
      (np2oscfg.JOYPAD1 & (~1)) |
      ((IsDlgButtonChecked(IDC_JOYPAD1) != BST_UNCHECKED) ? 1 : 0);
 ...
 * コンストラクタ
 */
SndOptFMGenPage::SndOptFMGenPage() : CPropPageProc(IDD_SNDFMGEN) {}
...
void dialog_sndopt(HWND hwndParent) {
  ...
  prop.m_psh.hIcon =
      LoadIcon(CWndProc::GetResourceHandle(), MAKEINTRESOURCE(IDI_ICON2));
