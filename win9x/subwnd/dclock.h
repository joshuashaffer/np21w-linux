...
enum { DCLOCK_WIDTH = 56, DCLOCK_HEIGHT = 12, DCLOCK_YALIGN = (56 / 8) };
 ...
 * @return インスタンス
 */
inline DispClock *DispClock::GetInstance() { return &sm_instance; }

/**
 * パレットを得る
 * @return パレット
 */
inline const RGB32 *DispClock::GetPalettes() const { return m_pal32; }
