...
#define WINVER                                                                 \
  0x0500 // Change this to the appropriate value to target other versions of
         // Windows.
                     ...
                     // NT4.0 SP3.
#define _WIN32_WINNT                                                           \
  0x0403 // Change this to the appropriate value to target other versions of
         // Windows.
#endif
...
#define _WIN32_WINDOWS                                                         \
  0x0400 // Change this to the appropriate value to target Windows 98 or later.
#endif

#ifndef _WIN32_IE // Specifies that the minimum required platform is Internet
                  // Explorer 2.0.
#define _WIN32_IE                                                              \
  0x0200 // Change this to the appropriate value to target other versions of IE.
#endif
