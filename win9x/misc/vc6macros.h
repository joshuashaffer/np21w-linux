...
#define GET_X_LPARAM(lp)                                                       \
  ((int)(short)LOWORD(lp)) /*!< x-coordinate from LPARAM */
#endif
#ifndef GET_Y_LPARAM
#define GET_Y_LPARAM(lp)                                                       \
  ((int)(short)HIWORD(lp)) /*!< y-coordinate from LPARAM */
#endif
...
#ifndef GWLP_WNDPROC
#define GWLP_WNDPROC                                                           \
  GWL_WNDPROC /*!< Retrieves the pointer to the window procedure */
#endif
...
#define GWLP_HWNDPARENT                                                        \
  GWL_HWNDPARENT /*!< Retrieves a handle to the parent window */
#endif
