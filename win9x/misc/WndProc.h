...
private:
  ...
  static LRESULT CALLBACK CbtFilterHook(int nCode, WPARAM wParam,
                                        LPARAM lParam);
};
 ...
 * @return インスタンス ハンドル
 */
inline HINSTANCE CWndProc::GetInstanceHandle() { return sm_hInstance; }
 ...
 * @return リソース ハンドル
 */
inline HINSTANCE CWndProc::GetResourceHandle() { return sm_hResource; }

/**
 * HWND オペレータ
 * @return HWND
 */
inline CWndProc::operator HWND() const { return m_hWnd; }
