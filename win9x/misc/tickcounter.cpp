...
int TickCounter::GetMode() { return m_mode; }
 ...
 * @return TICK
 */
DWORD GetTickCounter() { return s_tick.Get(); }

/**
 * カウンタモード設定
 */
void SetTickCounterMode(int mode) { s_tick.SetMode(mode); }
int GetTickCounterMode() { return s_tick.GetMode(); }

/**
 * クロックを得る
 * @return TICK
 */
LARGE_INTEGER GetTickCounter_Clock() { return s_tick.Get_rawclock(); }

/**
 * 1秒あたりのクロックを得る
 */
LARGE_INTEGER GetTickCounter_ClockPerSec() { return s_tick.Get_clockpersec(); }
