 ...
 */
CComPara::CComPara()
    : CComBase(COMCONNECT_PARALLEL), m_hParallel(INVALID_HANDLE_VALUE) {}
 ...
 * @return サイズ
 */
UINT CComPara::Read(UINT8 *pData) { return 0; }
 ...
 * @return ステータス
 */
UINT8 CComPara::GetStat() { return 0x00; }
 ...
 * @return リザルト コード
 */
INTPTR CComPara::Message(UINT nMessage, INTPTR nParam) { return 0; }
