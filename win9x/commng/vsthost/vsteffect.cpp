...
CVstEffect::CVstEffect()
    : m_effect(NULL), m_hModule(NULL), m_lpDir(NULL), m_pWnd(NULL) {}

/**
 * デストラクタ
 */
CVstEffect::~CVstEffect() { Unload(); }
...
bool CVstEffect::Load(LPCTSTR lpVst) {
  ...
  FnMain fnMain =
      reinterpret_cast<FnMain>(::GetProcAddress(hModule, "VSTPluginMain"));
  if (fnMain == NULL) {
 ...
 * @return The result
 */
VstIntPtr CVstEffect::dispatcher(VstInt32 opcode, VstInt32 index,
 ...
 */
void CVstEffect::processReplacing(float **inputs, float **outputs,
 ...
 * @return The result
 */
VstIntPtr CVstEffect::cAudioMasterCallback(AEffect *effect, VstInt32 opcode,
 ...
 * @return The result
 */
VstIntPtr CVstEffect::audioMasterCallback(VstInt32 opcode, VstInt32 index,
