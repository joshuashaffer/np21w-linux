...
public:
  ...
  CVstEditWnd();
  virtual ~CVstEditWnd();
  bool Create(CVstEffect *pEffect, LPCTSTR lpszWindowName, DWORD dwStyle,
 ...
 * @return ウィンドウ ハンドル
 */
inline HWND CVstEditWnd::GetHWnd() { return m_hWnd; }

/**
 * エフェクトを得る
 * @return エフェクト
 */
inline CVstEffect *CVstEditWnd::GetEffect() { return m_pEffect; }
