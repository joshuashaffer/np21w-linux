...
#define PACKETDATA                                                             \
  (PK_X | PK_Y | PK_BUTTONS | PK_NORMAL_PRESSURE | PK_ORIENTATION |            \
   PK_CURSOR | PK_STATUS | PK_TANGENT_PRESSURE | PK_ORIENTATION)
#define PACKETMODE 0
...
public:
  ...
  bool HandleMouseMoveMessage(HWND hWnd, UINT msg, WPARAM wParam,
                              LPARAM lParam);
  bool HandleMouseUpMessage(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam);
  bool HandleMouseDownMessage(HWND hWnd, UINT msg, WPARAM wParam,
                              LPARAM lParam);
  bool SkipMouseEvent();
