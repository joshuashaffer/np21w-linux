...
interface IRealChipBase : public IUnknown {
  ...
  virtual HRESULT __stdcall getChipInterface(int id, REFIID riid,
                                             void **ppi) = 0;
};
...
static const GUID IID_IRealChip3 = {
    ...
    0x2432,
    0x4747,
    {0xac, 0x75, 0xe, 0xa6, 0xd9, 0x33, 0x67, 0x97}};
...
interface IGimic : public IUnknown {
  virtual int __stdcall getFWVer(UINT * major, UINT * minor, UINT * revision,
                                 UINT * build) = 0;
...
static const GUID IID_IC86BOX = {
    ...
    0xa93c,
    0x4a2f,
    {0x87, 0xca, 0xce, 0x3a, 0xc1, 0x9, 0x6e, 0xd5}};
