...
enum { RGB24_B = 0, RGB24_G = 1, RGB24_R = 2 };
...
#define FSCRNCFG_fscrnmod                                                      \
  (np2oscfg.fsrescfg && scrnrescfg.hasfscfg ? scrnrescfg.fscrnmod              \
                                            : np2oscfg.fscrnmod)
#define FSCRNCFG_d3d_imode                                                     \
  (np2oscfg.fsrescfg && scrnrescfg.hasfscfg ? scrnrescfg.d3d_imode             \
                                            : np2oscfg.d3d_imode)
