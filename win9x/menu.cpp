...
int menu_addmenures(HMENU hMenu, int nPos, UINT uID, BOOL bSeparator) {
  int nCount = 0;
  HINSTANCE hInstance =
      CWndProc::FindResourceHandle(MAKEINTRESOURCE(uID), RT_MENU);
 ...
 */
static BOOL InsertMenuString(HMENU hMenu, UINT uPosition, UINT uFlags,
                             UINT_PTR uIDNewItem, UINT uStringID) {
...
void sysmenu_update(HMENU hMenu) {
  ...
  CheckMenuItem(hMenu, IDM_SNAPENABLE,
                MF_BYCOMMAND | MFCHECK(np2oscfg.WINSNAP));
...
#endif
    InsertMenuString(hMenu, nPos, MF_BYPOSITION | MF_POPUP, (UINT_PTR)hmenuSub,
                     IDS_HDD);
  }
...
void xmenu_update(HMENU hMenu) {
  ...
  CheckMenuItem(hMenu, IDM_ROLLEFT,
                MF_BYCOMMAND | MFCHECK(nRotateMode == SCRNMODE_ROTATELEFT));
  CheckMenuItem(hMenu, IDM_ROLRIGHT,
                MF_BYCOMMAND | MFCHECK(nRotateMode == SCRNMODE_ROTATERIGHT));
  ...
  CheckMenuItem(hMenu, IDM_CPUSTABILIZER,
                MF_BYCOMMAND | MFCHECK(np2oscfg.cpustabf != 0));
#if defined(SUPPORT_ASYNC_CPU)
  CheckMenuItem(hMenu, IDM_ASYNCCPU,
                MF_BYCOMMAND | MFCHECK(np2cfg.asynccpu != 0));
#endif
  ...
  CheckMenuItem(hMenu, IDM_USENUMLOCK,
                MF_BYCOMMAND | MFCHECK(np2oscfg.USENUMLOCK));
  CheckMenuItem(hMenu, IDM_SWAPPAGEUPDOWN,
                MF_BYCOMMAND | MFCHECK(np2oscfg.xrollkey));
  ...
  CheckMenuItem(hMenu, IDM_PC9801_26K,
                MF_BYCOMMAND | MFCHECK(SOUND_SW == 0x02));
  CheckMenuItem(hMenu, IDM_PC9801_86, MF_BYCOMMAND | MFCHECK(SOUND_SW == 0x04));
  CheckMenuItem(hMenu, IDM_PC9801_26_86,
                MF_BYCOMMAND | MFCHECK(SOUND_SW == 0x06));
  CheckMenuItem(hMenu, IDM_PC9801_86_CB,
                MF_BYCOMMAND | MFCHECK(SOUND_SW == 0x14));
  CheckMenuItem(hMenu, IDM_PC9801_118,
                MF_BYCOMMAND | MFCHECK(SOUND_SW == 0x08));
  CheckMenuItem(hMenu, IDM_PC9801_86_WSS,
                MF_BYCOMMAND | MFCHECK(SOUND_SW == SOUNDID_PC_9801_86_WSS));
  CheckMenuItem(hMenu, IDM_MATE_X_PCM,
                MF_BYCOMMAND | MFCHECK(SOUND_SW == SOUNDID_MATE_X_PCM));
  CheckMenuItem(hMenu, IDM_PC9801_86_118,
                MF_BYCOMMAND | MFCHECK(SOUND_SW == SOUNDID_PC_9801_86_118));
  CheckMenuItem(hMenu, IDM_SPEAKBOARD,
                MF_BYCOMMAND | MFCHECK(SOUND_SW == 0x20));
  CheckMenuItem(hMenu, IDM_86SPEAKBOARD,
                MF_BYCOMMAND | MFCHECK(SOUND_SW == SOUNDID_86_SPEAKBOARD));
  CheckMenuItem(hMenu, IDM_SPARKBOARD,
                MF_BYCOMMAND | MFCHECK(SOUND_SW == 0x40));
#if defined(SUPPORT_SOUND_SB16)
  CheckMenuItem(hMenu, IDM_SB16,
                MF_BYCOMMAND | MFCHECK(SOUND_SW == SOUNDID_SB16));
  CheckMenuItem(hMenu, IDM_PC9801_86_SB16,
                MF_BYCOMMAND | MFCHECK(SOUND_SW == SOUNDID_PC_9801_86_SB16));
  CheckMenuItem(hMenu, IDM_WSS_SB16,
                MF_BYCOMMAND | MFCHECK(SOUND_SW == SOUNDID_WSS_SB16));
  CheckMenuItem(hMenu, IDM_PC9801_86_WSS_SB16,
                MF_BYCOMMAND |
                    MFCHECK(SOUND_SW == SOUNDID_PC_9801_86_WSS_SB16));
  CheckMenuItem(hMenu, IDM_PC9801_118_SB16,
                MF_BYCOMMAND | MFCHECK(SOUND_SW == SOUNDID_PC_9801_118_SB16));
  CheckMenuItem(hMenu, IDM_PC9801_86_118_SB16,
                MF_BYCOMMAND |
                    MFCHECK(SOUND_SW == SOUNDID_PC_9801_86_118_SB16));
  ...
  CheckMenuItem(hMenu, IDM_SOUNDORCHESTRA,
                MF_BYCOMMAND | MFCHECK(SOUND_SW == 0x32));
  CheckMenuItem(hMenu, IDM_SOUNDORCHESTRAV,
                MF_BYCOMMAND | MFCHECK(SOUND_SW == 0x82));
  CheckMenuItem(hMenu, IDM_AMD98, MF_BYCOMMAND | MFCHECK(SOUND_SW == 0x80));
  CheckMenuItem(hMenu, IDM_WAVESTAR,
                MF_BYCOMMAND | MFCHECK(SOUND_SW == SOUNDID_WAVESTAR));
  ...
  CheckMenuItem(hMenu, IDM_FPU80,
                MF_BYCOMMAND | MFCHECK(fputype == FPU_TYPE_SOFTFLOAT));
  CheckMenuItem(hMenu, IDM_FPU64,
                MF_BYCOMMAND | MFCHECK(fputype == FPU_TYPE_DOSBOX));
  CheckMenuItem(hMenu, IDM_FPU64INT,
                MF_BYCOMMAND | MFCHECK(fputype == FPU_TYPE_DOSBOX2));
  ...
  CheckMenuItem(hMenu, IDM_MOUSE30X,
                MF_BYCOMMAND | MFCHECK(MMUL == 3 && MDIV == 1));
  CheckMenuItem(hMenu, IDM_MOUSE20X,
                MF_BYCOMMAND | MFCHECK(MMUL == 2 && MDIV == 1));
  CheckMenuItem(hMenu, IDM_MOUSE15X,
                MF_BYCOMMAND | MFCHECK(MMUL == 3 && MDIV == 2));
  CheckMenuItem(hMenu, IDM_MOUSE10X,
                MF_BYCOMMAND | MFCHECK(MMUL == 1 && MDIV == 1));
  CheckMenuItem(hMenu, IDM_MOUSED2X,
                MF_BYCOMMAND | MFCHECK(MMUL == 1 && MDIV == 2));
  CheckMenuItem(hMenu, IDM_MOUSED3X,
                MF_BYCOMMAND | MFCHECK(MMUL == 1 && MDIV == 3));
  CheckMenuItem(hMenu, IDM_MOUSED4X,
                MF_BYCOMMAND | MFCHECK(MMUL == 1 && MDIV == 4));
  ...
  CheckMenuItem(hMenu, IDM_SKIP16MEMCHK,
                MF_BYCOMMAND | MFCHECK(np2cfg.memchkmx != 0));
#if defined(SUPPORT_FAST_MEMORYCHECK)
  CheckMenuItem(hMenu, IDM_FASTMEMCHK,
                MF_BYCOMMAND | MFCHECK(np2cfg.memcheckspeed != 1));
#endif
