...
enum {
  ...
  ASE_HWMalfunction, //!< hardware is malfunctioning (can be returned by any
                     //!< ASIO function)
  ASE_InvalidParameter, //!< input parameter invalid
  ASE_InvalidMode,      //!< hardware is in a bad mode or used in a bad mode
  ASE_SPNotAdvancing,   //!< hardware is not running when sample position is
                        //!< inquired
...
enum {
  ...
  ASIOSTInt24MSB =
      1, //!< This is the packed 24 bit format. used for 20 bits as well
  ASIOSTInt32MSB = 2,
  ASIOSTFloat32MSB = 3, // IEEE 754 32 bit float
  ASIOSTFloat64MSB = 4, // IEEE 754 64 bit double float

  // these are used for 32 bit data buffer, with different alignment of the data
  // inside 32 bit PCI bus systems can be more easily used with these
  ...
  // these are used for 32 bit data buffer, with different alignment of the data
  // inside 32 bit PCI bus systems can more easily used with these
  ...
  //	ASIO DSD format.
  ASIOSTDSDInt8LSB1 = 32, // DSD 1 bit data, 8 samples per byte. First sample in
                          // Least significant bit.
  ASIOSTDSDInt8MSB1 = 33, // DSD 1 bit data, 8 samples per byte. First sample in
