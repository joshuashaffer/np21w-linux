...
typedef struct {
  ...
  UINT8 drawtype;  // Screen renderer type (0: DirectDraw, 1:
  ...
  UINT8 toolwndhistory; // Number of data of recently opened FD image list in
                        // Tool Window
...
enum { FULLSCREEN_WIDTH = 640, FULLSCREEN_HEIGHT = 480 };

enum { NP2BREAK_MAIN = 0x01, NP2BREAK_DEBUG = 0x02 };

enum { WM_NP2CMD = (WM_USER + 200) };
