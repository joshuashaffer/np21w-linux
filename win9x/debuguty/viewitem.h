 ...
 * @file	viewitem.h
 * @brief	DebugUty
 * 用ビュー基底クラスの宣言およびインターフェイスの定義をします
 */
...
class CDebugUtyItem {
public:
  static CDebugUtyItem *New(UINT nID, CDebugUtyView *lpView,
                            const CDebugUtyItem *lpItem = NULL);
 ...
 * @return ID
 */
inline UINT CDebugUtyItem::GetID() const { return m_nID; }
