...
static void viewmem_read(const DebugUtyViewMemory *cfg, UINT32 adrs, UINT8 *buf,
                         UINT32 size);

/**
 * 初期化
 */
DebugUtyViewMemory::DebugUtyViewMemory() { Update(); }
 ...
 */
void DebugUtyViewMemory::Read(UINT32 nAddress, LPVOID lpBuffer,
                              UINT32 cbBuffer) const {
