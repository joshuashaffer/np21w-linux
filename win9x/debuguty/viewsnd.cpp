...
static const SoundRegisterTable s_table[] = {
    {TEXT("Sound-Board I"), 0, 0}, {NULL, 0x0000, 0xffff},
    {NULL, 0x0010, 0x3f07},        {NULL, 0x0020, 0x07f6},
    {NULL, 0x0030, 0x7777},        {NULL, 0x0040, 0x7777},
    {NULL, 0x0050, 0x7777},        {NULL, 0x0060, 0x7777},
    {NULL, 0x0070, 0x7777},        {NULL, 0x0080, 0x7777},
    {NULL, 0x0090, 0x7777},        {NULL, 0x00a0, 0x7777},
    {NULL, 0x00b0, 0x0077},        {str_null, 0, 0},
    {NULL, 0x0100, 0xffff},        {NULL, 0x0110, 0x0001},
    {NULL, 0x0130, 0x7777},        {NULL, 0x0140, 0x7777},
    {NULL, 0x0150, 0x7777},        {NULL, 0x0160, 0x7777},
    {NULL, 0x0170, 0x7777},        {NULL, 0x0180, 0x7777},
    {NULL, 0x0190, 0x7777},        {NULL, 0x01a0, 0x7777},
    {NULL, 0x01b0, 0x0077},
#if 0
	{str_null, 0, 0},
 ...
 * @retval false 更新なし
 */
bool CDebugUtySnd::Update() { return m_buffer.empty(); }
 ...
 * アンロック
 */
void CDebugUtySnd::Unlock() { m_buffer.clear(); }
 ...
 */
bool CDebugUtySnd::IsLocked() { return (!m_buffer.empty()); }
...
void CDebugUtySnd::OnPaint(HDC hDC, const RECT &rect) {
  ...
  for (int y = 0; (y < rect.bottom) && (nIndex < _countof(s_table));
       y += 16, nIndex++) {
