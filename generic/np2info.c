...
static const OEMCHAR str_cpu[] =
    OEMTEXT("8086-2\00070116\00080286\00080386\00080486\0Pentium\0PentiumPro");
static const OEMCHAR str_winclr[] =
    OEMTEXT("256-colors\00065536-colors\0full color\0true color");
static const OEMCHAR str_winmode[] = OEMTEXT(" (window)\0 (fullscreen)");
static const OEMCHAR str_grcgchip[] =
    OEMTEXT("\0GRCG \0GRCG CG-Window \0EGC CG-Window ");
...
static const OEMCHAR str_fpu[] = OEMTEXT(
    " none\0 Berkeley SoftFloat 80bit Extended Precision FPU\0 64bit Double "
    "Precision FPU\0 64bit Double Precision FPU + INT64 Load/Store");
...
static void info_base(OEMCHAR *str, int maxlen, const NP2INFOEX *ex) {
  ...
  milstr_ncpy(str, (pccore.cpumode & CPUMODE_8MHZ) ? str_8MHz : str_5MHz,
              maxlen);
  (void)ex;
}
...
static void info_gdc2(OEMCHAR *str, int maxlen, const NP2INFOEX *ex) {
  ...
  OEMSPRINTF(textstr, str_dispclock, gdc.hclock / 1000, (gdc.hclock / 10) % 100,
...
static void info_extsnd(OEMCHAR *str, int maxlen, const NP2INFOEX *ex) {
  ...
  if (g_nSoundID & 4) {
    ...
    OEMSPRINTF(buf, str_pcm86a, pcm86rate8[g_pcm86.fifo & 7] >> 3,
...
static const INFOPROC infoproc[] = {
    {OEMTEXT("VER"), info_ver},       {OEMTEXT("CPU"), info_cpu},
    {OEMTEXT("CLOCK"), info_clock},   {OEMTEXT("BASE"), info_base},
    {OEMTEXT("MEM1"), info_mem1},     {OEMTEXT("MEM2"), info_mem2},
    {OEMTEXT("MEM3"), info_mem3},     {OEMTEXT("FPU"), info_fpu},
    {OEMTEXT("SIMD"), info_simd},     {OEMTEXT("GDC"), info_gdc},
    {OEMTEXT("GDC2"), info_gdc2},     {OEMTEXT("TEXT"), info_text},
    {OEMTEXT("GRPH"), info_grph},     {OEMTEXT("SND"), info_sound},
    {OEMTEXT("EXSND"), info_extsnd},  {OEMTEXT("BIOS"), info_bios},
    {OEMTEXT("RHYTHM"), info_rhythm}, {OEMTEXT("DISP"), info_display}};
