 ...
 * signal
 */
static void skbdwin_window_destroy(GtkWidget *w, gpointer p) {
...
static gboolean skbdwin_expose(GtkWidget *w, GdkEventExpose *ev) {
...
static gboolean skbdwin_key_press(GtkWidget *w, GdkEventKey *ev, gpointer p) {
...
static gboolean skbdwin_key_release(GtkWidget *w, GdkEventKey *ev, gpointer p) {
...
static gboolean skbdwin_button_press(GtkWidget *w, GdkEventButton *ev,
                                     gpointer p) {
...
static gboolean skbdwin_button_release(GtkWidget *w, GdkEventButton *ev,
                                       gpointer p) {
...
void skbdwin_create(void) {
  ...
  g_signal_connect(G_OBJECT(da), "expose_event", G_CALLBACK(skbdwin_expose),
                   NULL);
