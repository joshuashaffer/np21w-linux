...
static UINT ucs2tosjis(char *lpOutput, UINT cchOutput, const UINT16 *lpInput,
                       UINT cbInput);
static UINT utf8tosjis(char *lpOutput, UINT cchOutput, const char *lpInput,
                       UINT cbInput);
...
UINT codecnv_utf8tosjis(char *lpOutput, UINT cchOutput, const char *lpInput,
  ...
  if (cbInput != (UINT)-1) {
    ...
    // String mode
    nLength =
        utf8tosjis(lpOutput, cchOutput - 1, lpInput, (UINT)strlen(lpInput));
    if (lpOutput) {
      lpOutput[nLength] = '\0';
    }
    return nLength + 1;
