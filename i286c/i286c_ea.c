...
static UINT32 ea_bx_si(void) { return (LOW16(I286_BX + I286_SI) + DS_FIX); }
...
static UINT32 ea_bx_di(void) { return (LOW16(I286_BX + I286_DI) + DS_FIX); }
...
static UINT32 ea_bp_si(void) { return (LOW16(I286_BP + I286_SI) + SS_FIX); }
...
static UINT32 ea_bp_di(void) { return (LOW16(I286_BP + I286_DI) + SS_FIX); }
...
static UINT32 ea_si(void) { return (I286_SI + DS_FIX); }
...
static UINT32 ea_di(void) { return (I286_DI + DS_FIX); }
...
static UINT32 ea_bx(void) { return (I286_BX + DS_FIX); }
...
static const CALCEA i286c_ea_dst_tbl[] = {
    ea_bx_si,        ea_bx_di,        ea_bp_si,        ea_bp_di,
    ea_si,           ea_di,           ea_disp16,       ea_bx,
    ea_bx_si_disp8,  ea_bx_di_disp8,  ea_bp_si_disp8,  ea_bp_di_disp8,
    ea_si_disp8,     ea_di_disp8,     ea_bp_disp8,     ea_bx_disp8,
    ea_bx_si_disp16, ea_bx_di_disp16, ea_bp_si_disp16, ea_bp_di_disp16,
    ea_si_disp16,    ea_di_disp16,    ea_bp_disp16,    ea_bx_disp16};

// ----

static UINT16 lea_bx_si(void) { return (I286_BX + I286_SI); }
...
static UINT16 lea_bx_di(void) { return (I286_BX + I286_DI); }
...
static UINT16 lea_bp_si(void) { return (I286_BP + I286_SI); }
...
static UINT16 lea_bp_di(void) { return (I286_BP + I286_DI); }
...
static UINT16 lea_si(void) { return (I286_SI); }
...
static UINT16 lea_di(void) { return (I286_DI); }
...
static UINT16 lea_bx(void) { return (I286_BX); }
...
static const CALCLEA i286c_lea_tbl[] = {
    lea_bx_si,        lea_bx_di,        lea_bp_si,        lea_bp_di,
    lea_si,           lea_di,           lea_disp16,       lea_bx,
    lea_bx_si_disp8,  lea_bx_di_disp8,  lea_bp_si_disp8,  lea_bp_di_disp8,
    lea_si_disp8,     lea_di_disp8,     lea_bp_disp8,     lea_bx_disp8,
    lea_bx_si_disp16, lea_bx_di_disp16, lea_bp_si_disp16, lea_bp_di_disp16,
    lea_si_disp16,    lea_di_disp16,    lea_bp_disp16,    lea_bx_disp16};
...
static const GETLEA i286c_ea_tbl[] = {
    a_bx_si,        a_bx_di,        a_bp_si,        a_bp_di,
    a_si,           a_di,           a_disp16,       a_bx,
    a_bx_si_disp8,  a_bx_di_disp8,  a_bp_si_disp8,  a_bp_di_disp8,
    a_si_disp8,     a_di_disp8,     a_bp_disp8,     a_bx_disp8,
    a_bx_si_disp16, a_bx_di_disp16, a_bp_si_disp16, a_bp_di_disp16,
    a_si_disp16,    a_di_disp16,    a_bp_disp16,    a_bx_disp16};
...
static UINT32 ea_nop(void) { return (0); }
