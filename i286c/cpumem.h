...
#define MEML_READ8(addr) memp_read8((addr))
#define MEML_READ16(addr) memp_read16((addr))
#define MEML_WRITE8(addr, dat) memp_write8((addr), (dat))
#define MEML_WRITE16(addr, dat) memp_write16((addr), (dat))
#define MEML_READS(addr, dat, leng) memp_reads((addr), (dat), (leng))
#define MEML_WRITES(addr, dat, leng) memp_writes((addr), (dat), (leng))
