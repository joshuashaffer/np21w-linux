...
I286FN _reserved(void) { INT_NUM(6, I286_IP - 1); }
...
I286FN _daa(void) { // 27: daa
  ...
  I286_OV =
      ((I286_AL < 0x80) &&
       ((I286_AL >= 0x7a) || ((I286_AL >= 0x1a) && (I286_FLAGL & C_FLAG))));
...
I286FN _jnle_short(void) { // 7F:	jg/jnle short
  ...
  if ((I286_FLAGL & Z_FLAG) || (((I286_FLAGL & S_FLAG) == 0) != (I286_OV == 0)))
    JMPNOP(3) else JMPSHORT(7)
}
...
I286FN _mov_al_imm(void) MOVIMM8(I286_AL)     // B0:	mov		al, imm8
    ...
    I286FN _mov_ax_imm(void)
        MOVIMM16(I286_AX) // B8:	mov		ax, imm16
    I286FN _mov_cx_imm(void)
        MOVIMM16(I286_CX) // B9:	mov		cx, imm16
    I286FN _mov_dx_imm(void)
        MOVIMM16(I286_DX) // BA:	mov		dx, imm16
    I286FN _mov_bx_imm(void)
        MOVIMM16(I286_BX) // BB:	mov		bx, imm16
    I286FN _mov_sp_imm(void)
        MOVIMM16(I286_SP) // BC:	mov		sp, imm16
    I286FN _mov_bp_imm(void)
        MOVIMM16(I286_BP) // BD:	mov		bp, imm16
    I286FN _mov_si_imm(void)
        MOVIMM16(I286_SI) // BE:	mov		si, imm16
    I286FN _mov_di_imm(void)
        MOVIMM16(I286_DI) // BF:	mov		di, imm16
