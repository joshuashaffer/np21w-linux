...
I286_0F _lmsw(UINT op) {
  ...
  if (msw & MSW_PE) {
    TRACEOUT(("80286 ProtectMode Enable... / MSW=%.4x [%.4x:%.4x]", I286_MSW,
              I286_CS, I286_IP));
  }
}

static const I286OP_0F cts0_table[] = {_sldt, _str,  _lldt, _ltr,
                                       _verr, _verw, _verr, _verw};

static const I286OP_0F cts1_table[] = {__sgdt, _sidt, __lgdt, _lidt,
