// palette
//	 00		text palette				(NP2PAL_TEXT: pal0s +
//text) 	+0A		skipline palette			(NP2PAL_SKIP:
//skiplines)
//	+10		grph palette				(NP2PAL_GRPH: grph
//only) 	+80		text+grph
//(NP2PAL_TEXT2:grph+text) 	+0A		black + text palette
//(NP2PAL_TEXT3: text/grph=black)
