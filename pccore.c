...
#if defined(SUPPORT_IDEIO)
    sxsi_setdevtype(0x00, np2cfg.idetype[0] == SXSIDEV_CDROM ? SXSIDEV_CDROM
                                                             : SXSIDEV_NC);
    sxsi_setdevtype(0x01, np2cfg.idetype[1] == SXSIDEV_CDROM ? SXSIDEV_CDROM
                                                             : SXSIDEV_NC);
    sxsi_setdevtype(0x02, np2cfg.idetype[2] == SXSIDEV_CDROM ? SXSIDEV_CDROM
                                                             : SXSIDEV_NC);
    sxsi_setdevtype(0x03, np2cfg.idetype[3] == SXSIDEV_CDROM ? SXSIDEV_CDROM
                                                             : SXSIDEV_NC);
#endif
  } else {
...
#ifdef UNICODE
    WideCharToMultiByte(CP_ACP, 0, np2cfg.cpu_vendor_o, -1, np2cfg.cpu_vendor,
                        12 + 1, NULL, NULL);
#else
...
#ifdef UNICODE
    WideCharToMultiByte(CP_ACP, 0, np2cfg.cpu_brandstring_o, -1,
                        np2cfg.cpu_brandstring, 48 + 1, NULL, NULL);
#else
