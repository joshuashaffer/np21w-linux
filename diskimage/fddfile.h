...
#include "diskimage/fd/fdd_head_nfd.h"  //	堤蚊(kai1)
#include "diskimage/fd/fdd_head_vfdd.h" //	堤蚊(kai1)
...
enum { DISKTYPE_2D = 0, DISKTYPE_2DD, DISKTYPE_2HD };
...
enum { DISKTYPE_NOTREADY = 0, DISKTYPE_BETA, DISKTYPE_D88 };
