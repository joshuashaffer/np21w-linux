...
#define LOADMOTOROLAQWORD(a)                                                   \
  (((UINT64)((UINT8 *)(a))[7]) | ((UINT64)(((UINT8 *)(a))[6]) << 8) |          \
   ((UINT64)(((UINT8 *)(a))[5]) << 16) | ((UINT64)(((UINT8 *)(a))[4]) << 24) | \
   ((UINT64)(((UINT8 *)(a))[3]) << 32) | ((UINT64)(((UINT8 *)(a))[2]) << 40) | \
   ((UINT64)(((UINT8 *)(a))[1]) << 48) | ((UINT64)(((UINT8 *)(a))[0]) << 56))
#endif

#ifndef LOADMOTOROLADWORD
#define LOADMOTOROLADWORD(a)                                                   \
  (((UINT32)((UINT8 *)(a))[3]) | ((UINT32)(((UINT8 *)(a))[2]) << 8) |          \
   ((UINT32)(((UINT8 *)(a))[1]) << 16) | ((UINT32)(((UINT8 *)(a))[0]) << 24))
#endif

#ifndef LOADMOTOROLAWORD
#define LOADMOTOROLAWORD(a)                                                    \
  (((UINT16)((UINT8 *)(a))[1]) | ((UINT16)(((UINT8 *)(a))[0]) << 8))
#endif

#ifndef STOREMOTOROLAQWORD
#define STOREMOTOROLAQWORD(a, b)                                               \
  *(((UINT8 *)(a)) + 7) = (UINT8)((b));                                        \
  *(((UINT8 *)(a)) + 6) = (UINT8)((b) >> 8);                                   \
