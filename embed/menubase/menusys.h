...
#define menusys_gethide(id) ((int)menusys_msg(SMSG_GETHIDE, (id), 0))

#define menusys_setenable(id, enable)                                          \
  menusys_msg(SMSG_SETENABLE, (id), (long)(enable))
#define menusys_getenable(id) ((int)menusys_msg(SMSG_GETENABLE, (id), 0))

#define menusys_setcheck(id, checked)                                          \
  menusys_msg(SMSG_SETCHECK, (id), (long)(checked))
#define menusys_getcheck(id) ((int)menusys_msg(SMSG_GETCHECK, (id), 0))

#define menusys_settext(id, str) menusys_msg(SMSG_SETTEXT, (id), (INTPTR)(str))
