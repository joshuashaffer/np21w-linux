...
enum { DLGMSG_CREATE = 0, DLGMSG_COMMAND, DLGMSG_CLOSE, DLGMSG_DESTROY };
...
#define menudlg_sethide(id, hidden) menudlg_msg(DMSG_SETHIDE, (id), (hidden))
#define menudlg_setenable(id, enable)                                          \
  menudlg_msg(DMSG_SETENABLE, (id), (enable))
#define menudlg_setval(id, val) menudlg_msg(DMSG_SETVAL, (id), (UINT)(val))
#define menudlg_getval(id) ((UINT)menudlg_msg(DMSG_GETVAL, (id), 0))
#define menudlg_setvram(id, vram)                                              \
  ((VRAMHDL)menudlg_msg(DMSG_SETVRAM, (id), (INTPTR)(vram)))
#define menudlg_settext(id, arg) menudlg_msg(DMSG_SETTEXT, (id), (INTPTR)(arg))
#define menudlg_seticon(id, val) menudlg_msg(DMSG_SETICON, (id), (val))
#define menudlg_itemappend(id, arg)                                            \
  menudlg_msg(DMSG_ITEMAPPEND, (id), (INTPTR)(arg))
#define menudlg_itemreset(id) menudlg_msg(DMSG_ITEMRESET, (id), 0)
#define menudlg_itemsetex(id, arg)                                             \
  menudlg_msg(DMSG_ITEMSETEX, (id), (INTPTR)(arg))
#define menudlg_setlistpos(id, num) menudlg_msg(DMSG_SETLISTPOS, (id), (num))
#define menudlg_setrect(id, rect)                                              \
  menudlg_msg(DMSG_SETRECT, (id), (INTPTR)(rect))
#define menudlg_getrect(id) ((RECT_T *)menudlg_msg(DMSG_GETRECT, (id), 0))
#define menudlg_setfont(id, font)                                              \
  menudlg_msg(DMSG_SETFONT, (id), (INTPTR)(font))
#define menudlg_getfont(id) menudlg_msg(DMSG_GETFONT, (id), 0)
