...
static const MENUPRM res_cfg[] = {
    {DLGTYPE_FRAME, DID_STATIC, 0, str_cpu, 6, 6, 185, 58},
    {DLGTYPE_LTEXT, DID_STATIC, 0, str_base, 16, 21, 38, 11},
    {DLGTYPE_RADIO, DID_CLOCK1, MENU_TABSTOP, str_2mhz, 54, 21, 64, 11},
    {DLGTYPE_RADIO, DID_CLOCK2, 0, str_2halfmhz, 119, 21, 64, 11},
    {DLGTYPE_LTEXT, DID_STATIC, 0, str_mul, 16, 39, 63, 11},
    {DLGTYPE_SLIDER, DID_MULTIPLE, MSS_BOTH | MENU_TABSTOP,
     (void *)SLIDERPOS(1, 16), 80, 38, 63, 13},
    {DLGTYPE_LTEXT, DID_MULSTR, 0, NULL, 152, 39, 36, 11},
    {DLGTYPE_RTEXT, DID_CLOCKSTR, 0, NULL, 105, 51, 80, 11},
    {DLGTYPE_FRAME, DID_STATIC, 0, str_arch, 6, 70, 244, 30},
    {DLGTYPE_RADIO, DID_MODELVM, MENU_TABSTOP, str_vm, 16, 84, 78, 11},
    {DLGTYPE_RADIO, DID_MODELVX, 0, str_vx, 96, 84, 78, 11},
    {DLGTYPE_RADIO, DID_MODELEPSON, 0, str_epson, 176, 84, 60, 11},
    {DLGTYPE_FRAME, DID_STATIC, 0, str_sound, 6, 106, 244, 52},
    {DLGTYPE_LTEXT, DID_STATIC, 0, str_rate, 16, 121, 40, 11},
    {DLGTYPE_RADIO, DID_RATE11, MENU_TABSTOP, str_11khz, 60, 121, 60, 11},
    {DLGTYPE_RADIO, DID_RATE22, 0, str_22khz, 120, 121, 60, 11},
    {DLGTYPE_RADIO, DID_RATE44, 0, str_44khz, 180, 121, 60, 11},
    {DLGTYPE_LTEXT, DID_STATIC, 0, str_buffer, 16, 139, 40, 11},
    {DLGTYPE_SLIDER, DID_BUFFER, MSS_BOTH | MENU_TABSTOP,
     (void *)SLIDERPOS(100, 1000), 60, 138, 140, 13},
    {DLGTYPE_RTEXT, DID_BUFSTR, 0, NULL, 200, 139, 44, 11},
    {DLGTYPE_CHECK, DID_RESUME, MENU_TABSTOP, str_resume, 6, 164, 128, 11},
    {DLGTYPE_BUTTON, DID_OK, MENU_TABSTOP, mstr_ok, 197, 11, 52, 15},
    {DLGTYPE_BUTTON, DID_CANCEL, MENU_TABSTOP, mstr_cancel, 197, 30, 52, 15}};
#else
static const MENUPRM res_cfg[] = {
    {DLGTYPE_FRAME, DID_STATIC, 0, str_cpu, 8, 7, 202, 69},
    {DLGTYPE_LTEXT, DID_STATIC, 0, str_base, 20, 24, 28, 13},
    {DLGTYPE_RADIO, DID_CLOCK1, MENU_TABSTOP, str_2mhz, 52, 24, 78, 13},
    {DLGTYPE_RADIO, DID_CLOCK2, 0, str_2halfmhz, 130, 24, 78, 13},
    {DLGTYPE_LTEXT, DID_STATIC, 0, str_mul, 20, 45, 64, 13},
    {DLGTYPE_SLIDER, DID_MULTIPLE, MSS_BOTH | MENU_TABSTOP,
     (void *)SLIDERPOS(1, 16), 84, 45, 80, 13},
    {DLGTYPE_LTEXT, DID_MULSTR, 0, NULL, 172, 45, 32, 13},
    {DLGTYPE_RTEXT, DID_CLOCKSTR, 0, NULL, 124, 59, 80, 13},
    {DLGTYPE_FRAME, DID_STATIC, 0, str_arch, 8, 83, 288, 38},
    {DLGTYPE_RADIO, DID_MODELVM, MENU_TABSTOP, str_vm, 20, 100, 98, 13},
    {DLGTYPE_RADIO, DID_MODELVX, 0, str_vx, 120, 100, 98, 13},
    {DLGTYPE_RADIO, DID_MODELEPSON, 0, str_epson, 220, 100, 60, 13},
    {DLGTYPE_FRAME, DID_STATIC, 0, str_sound, 8, 128, 288, 60},
    {DLGTYPE_LTEXT, DID_STATIC, 0, str_rate, 20, 145, 48, 13},
    {DLGTYPE_RADIO, DID_RATE11, MENU_TABSTOP, str_11khz, 68, 145, 66, 13},
    {DLGTYPE_RADIO, DID_RATE22, 0, str_22khz, 134, 145, 66, 13},
    {DLGTYPE_RADIO, DID_RATE44, 0, str_44khz, 200, 145, 66, 13},
    {DLGTYPE_LTEXT, DID_STATIC, 0, str_buffer, 20, 165, 48, 13},
    {DLGTYPE_SLIDER, DID_BUFFER, MSS_BOTH | MENU_TABSTOP,
     (void *)SLIDERPOS(100, 1000), 68, 165, 160, 13},
    {DLGTYPE_RTEXT, DID_BUFSTR, 0, NULL, 228, 165, 48, 13},
    {DLGTYPE_CHECK, DID_RESUME, MENU_TABSTOP, str_resume, 8, 197, 288, 13},
    {DLGTYPE_BUTTON, DID_OK, MENU_TABSTOP, mstr_ok, 218, 13, 77, 21},
    {DLGTYPE_BUTTON, DID_CANCEL, MENU_TABSTOP, mstr_cancel, 218, 38, 77, 21}};
#endif
