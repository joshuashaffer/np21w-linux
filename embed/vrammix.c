...
static BRESULT mixrect(MIX_RECT *r, const VRAMHDL dst, const RECT_T *rct,
  ...
  if (rct == NULL) {
    ...
    if ((rct->bottom <= 0) || (rct->right <= 0) || (rct->left >= dst->width) ||
        (rct->top >= dst->height)) {
      return (FAILURE);
    }
...
static BRESULT cpyrectex(MIXRECTEX *r, const VRAMHDL dst, const POINT_T *pt,
                         const VRAMHDL org, const VRAMHDL src,
                         const RECT_T *rct) {
...
static BRESULT mixrectex(MIXRECTEX *r, const VRAMHDL dst, const VRAMHDL org,
                         const RECT_T *rct, const VRAMHDL src,
                         const POINT_T *pt) {
  ...
  if (rct == NULL) {
    ...
    if ((rct->bottom <= 0) || (rct->right <= 0) || (rct->left >= dstwidth) ||
        (rct->top >= dstheight)) {
      return (FAILURE);
    }
    s.left = max(rct->left, 0);
...
static void vramsub_cpyp16w16(VRAMHDL dst, const VRAMHDL src, UINT pat16,
                              MIX_RECT *mr) {
...
static void vramsub_cpyp16h16(VRAMHDL dst, const VRAMHDL src, UINT pat16,
                              MIX_RECT *mr) {
...
static void vramsub_cpyex16a2(VRAMHDL dst, const VRAMHDL src, UINT alpha64,
                              MIX_RECT *mr) {
...
static void vramsub_cpya16(VRAMHDL dst, const VRAMHDL src, UINT alpha256,
                           MIX_RECT *mr) {
...
static void vramsub_cpyexp16w16(VRAMHDL dst, const VRAMHDL src, UINT pat16,
                                MIX_RECT *mr) {
...
static void vramsub_cpyexp16h16(VRAMHDL dst, const VRAMHDL src, UINT pat16,
                                MIX_RECT *mr) {
...
static void vramsub_cpyp16w24(VRAMHDL dst, const VRAMHDL src, UINT pat16,
                              MIX_RECT *mr) {
...
static void vramsub_cpyp16h24(VRAMHDL dst, const VRAMHDL src, UINT pat16,
                              MIX_RECT *mr) {
...
static void vramsub_cpyex24a2(VRAMHDL dst, const VRAMHDL src, UINT alpha64,
                              MIX_RECT *mr) {
...
static void vramsub_cpya24(VRAMHDL dst, const VRAMHDL src, UINT alpha256,
                           MIX_RECT *mr) {
...
static void vramsub_cpyexp16w24(VRAMHDL dst, const VRAMHDL src, UINT pat16,
                                MIX_RECT *mr) {
...
static void vramsub_cpyexp16h24(VRAMHDL dst, const VRAMHDL src, UINT pat16,
                                MIX_RECT *mr) {
...
void vramcpy_cpy(VRAMHDL dst, const POINT_T *pt, const VRAMHDL src,
                 const RECT_T *rct) {

  MIX_RECT mr;

  if ((cpyrect(&mr, dst, pt, src, rct) != SUCCESS) || (dst->bpp != src->bpp)) {
    return;
  }
  vramsub_cpy(dst, src, &mr);
}

void vramcpy_move(VRAMHDL dst, const POINT_T *pt, const VRAMHDL src,
                  const RECT_T *rct) {
...
void vramcpy_cpyall(VRAMHDL dst, const POINT_T *pt, const VRAMHDL src,
                    const RECT_T *rct) {
...
void vramcpy_cpypat(VRAMHDL dst, const POINT_T *pt, const VRAMHDL src,
                    const RECT_T *rct, const UINT8 *pat8) {
...
void vramcpy_cpyex(VRAMHDL dst, const POINT_T *pt, const VRAMHDL src,
                   const RECT_T *rct) {
...
void vramcpy_cpyexa(VRAMHDL dst, const POINT_T *pt, const VRAMHDL src,
                    const RECT_T *rct) {
...
void vramcpy_cpyalpha(VRAMHDL dst, const POINT_T *pt, const VRAMHDL src,
                      const RECT_T *rct, UINT alpha256) {
...
void vramcpy_mix(VRAMHDL dst, const VRAMHDL org, const POINT_T *pt,
                 const VRAMHDL src, const RECT_T *rct, UINT alpha64) {
...
void vramcpy_mixcol(VRAMHDL dst, const POINT_T *pt, const VRAMHDL src,
                    const RECT_T *rct, UINT32 color, UINT alpha64) {
...
void vramcpy_zoom(VRAMHDL dst, const POINT_T *pt, const VRAMHDL src,
                  const RECT_T *rct, int dot) {
...
void vramcpy_mosaic(VRAMHDL dst, const POINT_T *pt, const VRAMHDL src,
                    const RECT_T *rct, int dot) {
...
void vrammix_cpy(VRAMHDL dst, const RECT_T *rct, const VRAMHDL src,
                 const POINT_T *pt) {

  MIX_RECT mr;

  if ((mixrect(&mr, dst, rct, src, pt) != SUCCESS) || (dst->bpp != src->bpp)) {
    return;
  }
  vramsub_cpy(dst, src, &mr);
}

void vrammix_cpyall(VRAMHDL dst, const RECT_T *rct, const VRAMHDL src,
                    const POINT_T *pt) {
...
void vrammix_cpy2(VRAMHDL dst, const RECT_T *rct, const VRAMHDL src,
                  const POINT_T *pt, UINT alpha) {
...
void vrammix_cpypat(VRAMHDL dst, const RECT_T *rct, const VRAMHDL src,
                    const POINT_T *pt, const UINT8 *pat8) {
...
void vrammix_cpypat16w(VRAMHDL dst, const RECT_T *rct, const VRAMHDL src,
                       const POINT_T *pt, const UINT pat16) {
...
void vrammix_cpypat16h(VRAMHDL dst, const RECT_T *rct, const VRAMHDL src,
                       const POINT_T *pt, const UINT pat16) {
...
void vrammix_cpyex(VRAMHDL dst, const RECT_T *rct, const VRAMHDL src,
                   const POINT_T *pt) {
...
void vrammix_cpyex2(VRAMHDL dst, const RECT_T *rct, const VRAMHDL src,
                    const POINT_T *pt, UINT alpha64) {

  MIX_RECT mr;

  if ((mixrect(&mr, dst, rct, src, pt) != SUCCESS) || (src->alpha == NULL) ||
      (dst->bpp != src->bpp)) {
    return;
  }
#ifdef SUPPORT_16BPP
...
void vrammix_cpyexpat16w(VRAMHDL dst, const RECT_T *rct, const VRAMHDL src,
                         const POINT_T *pt, const UINT pat16) {
...
void vrammix_cpyexpat16h(VRAMHDL dst, const RECT_T *rct, const VRAMHDL src,
                         const POINT_T *pt, const UINT pat16) {
...
void vrammix_mix(VRAMHDL dst, const VRAMHDL org, const RECT_T *rct,
                 const VRAMHDL src, const POINT_T *pt, UINT alpha64) {
...
void vrammix_mixcol(VRAMHDL dst, const RECT_T *rct, const VRAMHDL src,
                    const POINT_T *pt, UINT32 color, UINT alpha64) {
...
void vrammix_mixalpha(VRAMHDL dst, const RECT_T *rct, const VRAMHDL src,
                      const POINT_T *pt, UINT32 color) {
...
void vrammix_graybmp(VRAMHDL dst, const VRAMHDL org, const RECT_T *rct,
                     const VRAMHDL src, const POINT_T *pt, const VRAMHDL bmp,
                     int delta) {
...
void vrammix_colex(VRAMHDL dst, const RECT_T *rct, const VRAMHDL src,
                   const POINT_T *pt, UINT32 color) {
...
#ifdef SUPPORT_16BPP
static void vramsub_resize16(VRAMHDL dst, MIX_RECT *drct, const VRAMHDL src,
                             const MIX_RECT *srct) {
...
#ifdef SUPPORT_24BPP
static void vramsub_resize24(VRAMHDL dst, MIX_RECT *drct, const VRAMHDL src,
                             const MIX_RECT *srct) {
...
void vrammix_resize(VRAMHDL dst, const RECT_T *drct, const VRAMHDL src,
                    const RECT_T *srct) {
...
static void vramsub_txt8p(VRAMHDL dst, const FNTDAT fnt, UINT32 color,
                          MIX_RECT *mr) {
...
#ifdef SUPPORT_16BPP
static void vramsub_txt16p(VRAMHDL dst, const FNTDAT fnt, UINT32 color,
                           MIX_RECT *mr) {
      ...
      if (alpha) {
        ...
        if (!alpha) {
          *(UINT16 *)q = (UINT16)col16;
          ...
          UINT d, s;
          s = *(UINT16 *)q;
          d = MAKEALPHA16s(c16[0], s, B16MASK, alpha, FDAT_DEPTHBIT);
          d |= MAKEALPHA16s(c16[1], s, G16MASK, alpha, FDAT_DEPTHBIT);
          d |= MAKEALPHA16s(c16[2], s, R16MASK, alpha, FDAT_DEPTHBIT);
          *(UINT16 *)q = (UINT16)d;
        }
      }
      q += 2;
...
static void vramsub_txt16a(VRAMHDL dst, const FNTDAT fnt, UINT32 color,
                           MIX_RECT *mr) {
...
static void vramsub_txt16e(VRAMHDL dst, const FNTDAT fnt, UINT32 color,
                           MIX_RECT *mr) {
...
#ifdef SUPPORT_24BPP
static void vramsub_txt24p(VRAMHDL dst, const FNTDAT fnt, UINT32 color,
                           MIX_RECT *mr) {
    ...
    do {
      ...
      if (alpha) {
        if (alpha == FDAT_DEPTH) {
          ...
          alpha += FDATDEPTHBASE;
          q[0] = (UINT8)MAKEALPHA24(q[0], c24[0], alpha, FDAT_DEPTHBIT);
          q[1] = (UINT8)MAKEALPHA24(q[1], c24[1], alpha, FDAT_DEPTHBIT);
          q[2] = (UINT8)MAKEALPHA24(q[2], c24[2], alpha, FDAT_DEPTHBIT);
        }
      }
      q += 3;
    } while (--cnt);
...
static void vramsub_txt24a(VRAMHDL dst, const FNTDAT fnt, UINT32 color,
                           MIX_RECT *mr) {
...
static void vramsub_txt24e(VRAMHDL dst, const FNTDAT fnt, UINT32 color,
                           MIX_RECT *mr) {
...
void vrammix_text(VRAMHDL dst, void *fhdl, const OEMCHAR *str, UINT32 color,
                  POINT_T *pt, const RECT_T *rct) {

  void (*func)(VRAMHDL dst, const FNTDAT fnt, UINT32 color, MIX_RECT *mr);
...
void vrammix_textex(VRAMHDL dst, void *fhdl, const OEMCHAR *str, UINT32 color,
                    POINT_T *pt, const RECT_T *rct) {
