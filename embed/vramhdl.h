...
#ifdef SUPPORT_16BPP
enum { B16MASK = 0x001f, G16MASK = 0x07e0, R16MASK = 0xf800 };

#define MAKE16PAL(c24)                                                         \
  ((((c24)&0x0000f8) >> 3) | (((c24)&0x00fc00) >> 5) | (((c24)&0xf80000) >> 8))
...
#define MAKEALPHA16(d, s, m, a, b)                                             \
  ((((d) & (m)) + ((((int)((s) & (m)) - (int)((d) & (m))) * (a)) >> (b))) & (m))

#define MAKEALPHA16s(d, s, m, a, b)                                            \
  (((d) + ((((int)((s) & (m)) - (int)(d)) * (a)) >> (b))) & (m))
#endif

#ifdef SUPPORT_24BPP
#define MAKEALPHA24(d, s, a, b) ((d) + ((((int)(s) - (int)(d)) * (a)) >> (b)))
#endif
