...
#define MEMP_READ8(addr) i286_memoryread((addr))
#define MEMP_WRITE8(addr, dat) i286_memorywrite((addr), (dat))

// ---- Logical Space (BIOS)

#define MEML_READ8(addr) i286_memoryread((addr))
#define MEML_READ16(addr) i286_memoryread_w((addr))
#define MEML_WRITE8(addr, dat) i286_memorywrite((addr), (dat))
#define MEML_WRITE16(addr, dat) i286_memorywrite_w((addr), (dat))
#define MEML_READS(addr, dat, leng) i286_memx_read((addr), (dat), (leng))
#define MEML_WRITES(addr, dat, leng) i286_memx_write((addr), (dat), (leng))

#define MEMR_READ8(seg, off) i286_membyte_read((seg), (off))
#define MEMR_READ16(seg, off) i286_memword_read((seg), (off))
#define MEMR_WRITE8(seg, off, dat) i286_membyte_write((seg), (off), (dat))
#define MEMR_WRITE16(seg, off, dat) i286_memword_write((seg), (off), (dat))
