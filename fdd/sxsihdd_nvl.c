...
BOOL nvl_check() {
  ...
  if (!GetProcAddress(hModule, MAKEINTRESOURCEA(1)))
    goto check_err;
  if (!GetProcAddress(hModule, MAKEINTRESOURCEA(2)))
    goto check_err;
  if (!GetProcAddress(hModule, MAKEINTRESOURCEA(3)))
    goto check_err;
  if (!GetProcAddress(hModule, MAKEINTRESOURCEA(4)))
    goto check_err;
  if (!GetProcAddress(hModule, MAKEINTRESOURCEA(5)))
    goto check_err;
