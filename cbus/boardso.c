...
static const IOOUT opn_o[4] = {opn_o188, opn_o18a, opl2_o18c, opl2_o18e};

static const IOINP opn_i[4] = {opn_i188, opn_i18a, opl2_i18c, opl2_i18e};
...
void boardso_reset(const NP2CFG *pConfig, BOOL v) {
  ...
  opna_timer(&g_opna[0], (pConfig->snd26opt & 0xc0) | 0x10, NEVENT_FMTIMERA,
             NEVENT_FMTIMERB);
  opl3_reset(&g_opl3[G_OPL3_INDEX],
             (REG8)((v) ? OPL3_MODE_8950 : OPL3_MODE_3812));
...
void boardso_unbind(void) { cbuscore_detachsndex(0x188 - g_opna[0].s.base); }
