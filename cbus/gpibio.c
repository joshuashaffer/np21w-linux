/**
 * @file	gpib.c
 * @brief	Implementation of PC-9801-06/19/29/29K/29N GP-IB(IEEE-488.1)
 * Interface (uPD7210)
 */
...
// 拡張
static void IOOUTCALL gpib_o0(UINT port, REG8 dat) { (void)port; }
static REG8 IOOUTCALL gpib_i0(UINT port) { return 0xff; }

static void IOOUTCALL gpib_o2(UINT port, REG8 dat) { (void)port; }
static REG8 IOOUTCALL gpib_i2(UINT port) { return 0xff; }

static void IOOUTCALL gpib_o4(UINT port, REG8 dat) { (void)port; }
static REG8 IOOUTCALL gpib_i4(UINT port) { return 0xff; }

static void IOOUTCALL gpib_o6(UINT port, REG8 dat) { (void)port; }
static REG8 IOOUTCALL gpib_i6(UINT port) { return 0xff; }

static void IOOUTCALL gpib_o8(UINT port, REG8 dat) { (void)port; }
static REG8 IOOUTCALL gpib_i8(UINT port) { return 0xff; }

static void IOOUTCALL gpib_oa(UINT port, REG8 dat) { (void)port; }
static REG8 IOOUTCALL gpib_ia(UINT port) { return 0xff; }

static void IOOUTCALL gpib_oc(UINT port, REG8 dat) { (void)port; }
static REG8 IOOUTCALL gpib_ic(UINT port) { return 0xff; }

static void IOOUTCALL gpib_oe(UINT port, REG8 dat) { (void)port; }
static REG8 IOOUTCALL gpib_ie(UINT port) { return 0xff; }

static const IOOUT gpib_o[] = {
    gpib_o0, gpib_o1, gpib_o2, gpib_o3, gpib_o4, gpib_o5, gpib_o6, gpib_o7,
    gpib_o8, gpib_o9, gpib_oa, gpib_ob, gpib_oc, gpib_od, gpib_oe, gpib_of};

static const IOINP gpib_i[] = {
    gpib_i0, gpib_i1, gpib_i2, gpib_i3, gpib_i4, gpib_i5, gpib_i6, gpib_i7,
    gpib_i8, gpib_i9, gpib_ia, gpib_ib, gpib_ic, gpib_id, gpib_ie, gpib_if};
