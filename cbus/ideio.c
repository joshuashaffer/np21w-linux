    ...
    if (r) {
      ...
      if (samplen_n < samplen_d) {
        ...
        do {
          ...
          buf_l += (SINT)((int)(sampl)*np2cfg.davolume * cdda_softvolume_L /
                          255 / 31);
          buf_r += (SINT)((int)(sampr)*np2cfg.davolume * cdda_softvolume_R /
                          255 / 31);
          buf_count++;
        ...
        do {
          sampl = ((SINT8)ptr[1] << 8) + ptr[0];
          sampr = ((SINT8)ptr[3] << 8) + ptr[2];
          pcm[0] += (SINT)((int)(sampl)*np2cfg.davolume * cdda_softvolume_L /
                           255 / 31);
          pcm[1] += (SINT)((int)(sampr)*np2cfg.davolume * cdda_softvolume_L /
                           255 / 31);
