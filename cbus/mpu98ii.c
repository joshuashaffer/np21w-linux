...
static void mpu98ii_int(void) {
  ...
  // g_nSoundID == SOUNDID_WSS_SB16 || g_nSoundID == SOUNDID_PC_9801_86_WSS_SB16
  // || g_nSoundID == SOUNDID_PC_9801_118_SB16 || g_nSoundID ==
  // SOUNDID_PC_9801_86_118_SB16){ 	pic_setirq(g_sb16.dmairq);
  //}
  //// PC-9801-118
...
static const MPUCMDFN mpucmds[0x100] = {
    ...
    mpucmd_xx, mpucmd_xx, mpucmd_xx, mpucmd_xx, mpucmd_xx, mpucmd_xx,
    mpucmd_xx, mpucmd_xx, mpucmd_xx, mpucmd_xx, mpucmd_xx, mpucmd_ff};
...
void mpu98ii_construct(void) { cm_mpu98 = NULL; }
