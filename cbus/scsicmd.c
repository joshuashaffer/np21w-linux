...
#define SCSICMD_ERR                                                            \
  MessageBox(NULL, _T("SCSI error"), _T("?"), MB_OK);                          \
  exit(1);
#else
#define SCSICMD_ERR
#endif
...
static const UINT8 hdd_inquiry[0x20] = {
    0x00, 0x00, 0x02, 0x02, 0x1c, 0x00, 0x00, 0x18, 'N',  'E', 'C',
    0x20, 0x20, 0x20, 0x20, 0x20, 'N',  'P',  '2',  '-',  'H', 'D',
    'D',  0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20};
...
static const UINT8 stat2ret[16] = {0x40, 0x00, 0x10, 0x00, 0x20, 0x00,
