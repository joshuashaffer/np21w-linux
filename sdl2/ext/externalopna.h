 ...
 * @retval false 無効
 */
inline bool CExternalOpna::HasPsg() const { return m_bHasPsg; }
 ...
 * @retval false 無効
 */
inline bool CExternalOpna::HasRhythm() const { return m_bHasRhythm; }
 ...
 * @retval false 無効
 */
inline bool CExternalOpna::HasADPCM() const { return m_bHasADPCM; }
